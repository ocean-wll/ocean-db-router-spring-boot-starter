package pers.ocean.middleware.db.router.mybatis.interceptor;
...
public class DynamicMybatisInterceptor implements Interceptor {
     ...
     * sql中提取表名正则
     */
    private final Pattern TABLE_PATTERN = Pattern.compile("(from|into|update)[\\s]{1,}(\\w{1,})",
